...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0 rounded-2xl border border-border/50 bg-transparent shadow-2xl">
        {/* Princess accent bar */}
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        // icons inherit muted unless colored
        "[&_svg:not([class*='text-'])]:text-muted-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0",
        // disabled
